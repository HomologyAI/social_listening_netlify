...
export default function ThemeDetail({ theme, parentThemeSanitizedIdentifier }) {
  return (
      ...
      <div className="mt-6">
        ...
        <div className="space-y-6">
          {theme.second_level_themes.map((sub, index) => {
            const subThemeTitle = sub.label || 'untitled-subtheme';
            const subThemeId = `theme-detail-${parentThemeSanitizedIdentifier}-subtheme-${sanitizeForId(subThemeTitle)}`;
            return (
              <div id={subThemeId} key={index} className="bg-white border border-slate-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300 scroll-mt-20">
